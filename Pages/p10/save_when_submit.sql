...
begin
    ...
    -- --            ELSE P10_total_days
    -- --        END ||' </p>' ||
    -- '<p>Total Days: '|| to_char(P10_total_days, '0.0') ||' </p>' ||
    ...
    v_body_man := v_body_man || '<p style=''color:black''><strong style=''color:black''>- Đính kèm/ Attachment:</strong> '|| to_href_html(:P10_URL_FILES, :P10_NAME_FILES) ||'</p>';
