...
insert into EMPLOYEE_REQUESTS (
    ...
    START_TIME,END_TIME,SUBMIT_DATE,BENEFIT_CODE,CRF_DAY_TEMP,ANNUAL_DAY_TEMP,ATTACH_NAME,ATTATCH_FILE
        ...
        CASE WHEN :P10_END_DATE IS NULL OR :P10_END_DATE = '' THEN :P10_FROM_DATE ELSE :P10_END_DATE END ,to_char(:P10_ALL_DAY),:P10_NOTE,:P10_TOTAL_DAYS,2,:P10_ANNUAL_LEAVE,:P10_APPROVED_MANAGER,:P10_MANAGER_CODE,
