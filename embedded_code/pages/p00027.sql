...
-- ----------------------------------------
-- Page: 27 - Approve Scholarship Request PK > Region: SCHOLARSHIP REQUEST I-GRID > Source > SQL Query
...
-- ----------------------------------------
-- Page: 27 - Approve Scholarship Request PK > Region: SCHOLARSHIP REQUEST I-GRID > Column: STATUS > List of Values > SQL Query

SELECT STATUS, ID AS ID
FROM STATUS;

-- ----------------------------------------
-- Page: 27 - Approve Scholarship Request PK > Page Item: P27_DATE_TO > Default > SQL Query

SELECT TO_CHAR(SYSDATE, 'MM/DD/YYYY') AS formatted_date FROM DUAL;

-- ----------------------------------------
-- Page: 27 - Approve Scholarship Request PK > Page Item: P27_DATE_FROM > Default > SQL Query
