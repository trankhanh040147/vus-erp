...
-- ----------------------------------------
-- Page: 20003 - scholarchip_request > Region: SCHOLARSHIP REQUEST I-GRID > Source > SQL Query
...
-- ----------------------------------------
-- Page: 20003 - scholarchip_request > Page Item: P20003_DATE_TO > Default > SQL Query

SELECT TO_CHAR(SYSDATE, 'MM/DD/YYYY') AS formatted_date FROM DUAL;

-- ----------------------------------------
-- Page: 20003 - scholarchip_request > Page Item: P20003_DATE_FROM > Default > SQL Query
